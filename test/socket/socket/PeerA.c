...
int main(int argc, char *argv[])
{
    ...
    if(p1==0)
    {
        ...
        if(0 == sending)
        {
            ...
            to= serv_addr;
            printf("\nPeerA sending ServerPort: %d\n", to.sin_port);
            tolen = sizeof(struct sockaddr);
            printf("\nPeerA sending tolen: %d\n",tolen);
        ...
        else
        {
            ...
            if(0 ==receiving )
            {
                ...
                printf("PeerA receiving Socket Binding Successful\n");
